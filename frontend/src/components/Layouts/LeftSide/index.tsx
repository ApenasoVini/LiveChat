...
import { socket } from "@/components/Layouts/Providers";
                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  {chat.unseen_count > 0 ? (
                    ...
                    chat.last_message.from_user.id == user?.id && (
                      <div
                        className={`${chat.last_message.viewed_at ? "text-emerald-600 dark:text-emerald-400" : "text-slate-800 dark:text-slate-300"}`}
                      >
